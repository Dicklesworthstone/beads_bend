...
### DISC-008 — the JS lane faults on a store above about 30 KB   [2026-09-20 | Platform | OPEN]
...
- Approver: pending (the repository owner). Until it is accepted it counts as a bug, and it blocks the Phase 3 exit item E8.3.

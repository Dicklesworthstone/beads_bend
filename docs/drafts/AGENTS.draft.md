<!-- DRAFT for owner review. Proposed replacement for /data/projects/beads_bend/AGENTS.md.
     Form copied from /dp/beads_rust/AGENTS.md; every rule of the scaffold's AGENTS.md is carried over.
     Until the owner promotes this file, the live mandate is the AGENTS.md at the repository root. -->
